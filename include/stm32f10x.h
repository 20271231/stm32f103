...
typedef struct
{
  ...
  __IO uint32_t CR;// 偏移 +0x00  ← 第 1 个
  __IO uint32_t CFGR;// 偏移 +0x04  ← 第 2 个
  __IO uint32_t CIR;// 偏移 +0x08  ← 第 3 个
  __IO uint32_t APB2RSTR;// 偏移 +0x0C  ← 第 4 个
  __IO uint32_t APB1RSTR;// 偏移 +0x10  ← 第 5 个
  __IO uint32_t AHBENR;// 偏移 +0x14  ← 第 6 个
  __IO uint32_t APB2ENR;// 偏移 +0x18  ← 第 7 个  ==>>  0x40000000 + 0x20000 + 0x1000 + 0x18 = 0x40021018
  __IO uint32_t APB1ENR;// 偏移 +0x1C  ← 第 8 个
  __IO uint32_t BDCR;    // 偏移 +0x20  ← 第 9 个
  __IO uint32_t CSR;     // 偏移 +0x24  ← 第 10 个
